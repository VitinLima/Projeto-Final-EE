...
${OBJECTDIR}/_ext/1316310907/ledMatrix.p1: C:/Users/160047412/Desktop/ProjetoFinal.X/ledMatrix.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/_ext/1316310907" 
	@${RM} ${OBJECTDIR}/_ext/1316310907/ledMatrix.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1316310907/ledMatrix.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/_ext/1316310907/ledMatrix.p1 C:/Users/160047412/Desktop/ProjetoFinal.X/ledMatrix.c 
	@-${MV} ${OBJECTDIR}/_ext/1316310907/ledMatrix.d ${OBJECTDIR}/_ext/1316310907/ledMatrix.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1316310907/ledMatrix.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
